...
`SPY_ORB15_0950_RANGE_INVALID_STOP15` y
`SPY_ORB15_0950_CALL_CLOSE80_TP125_STOP15_RANGE_INVALID`. La representante es
`SPY_ORB15_0950_CALL_CLOSE80_TP125_STOP15`, porque preserva el mejor edge anual
del grupo CALL 09:50; la compuesta redujo el neto anual frente a esa variante.
